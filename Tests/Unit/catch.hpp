...
// CATCH_CONFIG_CPP11_GENERATED_METHODS : The delete and default keywords for compiler generated
// methods CATCH_CONFIG_CPP11_IS_ENUM : std::is_enum is supported? CATCH_CONFIG_CPP11_TUPLE :
// std::tuple is supported CATCH_CONFIG_CPP11_LONG_LONG : is long long supported?
...
// Use variadic macros if the compiler supports them
    ...
    (defined __WAVE__ && __WAVE_HAS_VARIADICS) || (defined __GNUC__ && __GNUC__ >= 3) ||           \
...
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_LONG_LONG) && !defined(CATCH_CONFIG_NO_LONG_LONG) &&       \
    !defined(CATCH_CONFIG_CPP11_LONG_LONG) && !defined(CATCH_CONFIG_NO_CPP11)
#define CATCH_CONFIG_CPP11_LONG_LONG
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_OVERRIDE) && !defined(CATCH_CONFIG_NO_OVERRIDE) &&         \
    !defined(CATCH_CONFIG_CPP11_OVERRIDE) && !defined(CATCH_CONFIG_NO_CPP11)
#define CATCH_CONFIG_CPP11_OVERRIDE
#endif
#if defined(CATCH_INTERNAL_CONFIG_CPP11_UNIQUE_PTR) && !defined(CATCH_CONFIG_NO_UNIQUE_PTR) &&     \
...
inline void
deleteAll(ContainerT& container)
{
...
inline void
deleteAllValues(AssociativeContainerT& container)
{
...
void
throwLogicError(std::string const& message, SourceLineInfo const& locationInfo);
...
cleanUpContext();
Stream
createStream(std::string const& streamName);
}
...
inline ResultDisposition::Flags
...
Matcher<ExpressionT>::operator&&(Matcher<ExpressionT> const& other) const
{
...
inline std::string
makeString(std::string const& str)
{
	return str;
}
inline std::string
...
AllOf(Impl::Matcher<ExpressionT> const& m1, Impl::Matcher<ExpressionT> const& m2)
{
...
AnyOf(Impl::Matcher<ExpressionT> const& m1, Impl::Matcher<ExpressionT> const& m2)
{
...
inline Impl::StdString::StartsWith
StartsWith(std::string const& substr)
{
	return Impl::StdString::StartsWith(substr);
}
inline Impl::StdString::StartsWith
StartsWith(const char* substr)
{
	return Impl::StdString::StartsWith(Impl::StdString::makeString(substr));
}
inline Impl::StdString::EndsWith
EndsWith(std::string const& substr)
{
	return Impl::StdString::EndsWith(substr);
}
inline Impl::StdString::EndsWith
EndsWith(const char* substr)
{
...
bool
applyEvaluator(T1 const& lhs, T2 const& rhs)
{
...
template<Operator Op, typename T1, typename T2>
bool
compare(T1 const& lhs, T2 const& rhs)
{
	return Evaluator<T1, T2, Op>::evaluate(lhs, rhs);
}
...
template<Operator Op>
bool
compare(unsigned int lhs, int rhs)
{
	return applyEvaluator<Op>(lhs, static_cast<unsigned int>(rhs));
}
template<Operator Op>
bool
compare(unsigned long lhs, int rhs)
{
	return applyEvaluator<Op>(lhs, static_cast<unsigned int>(rhs));
}
template<Operator Op>
bool
compare(unsigned char lhs, int rhs)
{
	return applyEvaluator<Op>(lhs, static_cast<unsigned int>(rhs));
}
...
template<Operator Op>
bool
compare(unsigned int lhs, long rhs)
{
	return applyEvaluator<Op>(lhs, static_cast<unsigned long>(rhs));
}
template<Operator Op>
bool
compare(unsigned long lhs, long rhs)
{
	return applyEvaluator<Op>(lhs, static_cast<unsigned long>(rhs));
}
template<Operator Op>
bool
compare(unsigned char lhs, long rhs)
{
	return applyEvaluator<Op>(lhs, static_cast<unsigned long>(rhs));
}
...
template<Operator Op>
bool
compare(int lhs, unsigned int rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned int>(lhs), rhs);
}
template<Operator Op>
bool
compare(int lhs, unsigned long rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned int>(lhs), rhs);
}
template<Operator Op>
bool
compare(int lhs, unsigned char rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned int>(lhs), rhs);
}
...
template<Operator Op>
bool
compare(long lhs, unsigned int rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned long>(lhs), rhs);
}
template<Operator Op>
bool
compare(long lhs, unsigned long rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned long>(lhs), rhs);
}
template<Operator Op>
bool
compare(long lhs, unsigned char rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned long>(lhs), rhs);
}
...
bool
compare(long lhs, T* rhs)
{
	return Evaluator<T*, T*, Op>::evaluate(reinterpret_cast<T*>(lhs), rhs);
}
template<Operator Op, typename T>
bool
compare(T* lhs, long rhs)
{
...
template<Operator Op, typename T>
bool
compare(int lhs, T* rhs)
{
	return Evaluator<T*, T*, Op>::evaluate(reinterpret_cast<T*>(lhs), rhs);
}
template<Operator Op, typename T>
bool
compare(T* lhs, int rhs)
{
	return Evaluator<T*, T*, Op>::evaluate(lhs, reinterpret_cast<T*>(rhs));
}
...
template<Operator Op>
bool
compare(long long lhs, unsigned int rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned long>(lhs), rhs);
}
template<Operator Op>
bool
compare(long long lhs, unsigned long rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned long>(lhs), rhs);
}
template<Operator Op>
bool
compare(long long lhs, unsigned long long rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned long>(lhs), rhs);
}
template<Operator Op>
bool
compare(long long lhs, unsigned char rhs)
{
	return applyEvaluator<Op>(static_cast<unsigned long>(lhs), rhs);
}
...
template<Operator Op>
bool
compare(unsigned long long lhs, int rhs)
{
	return applyEvaluator<Op>(static_cast<long>(lhs), rhs);
}
template<Operator Op>
bool
compare(unsigned long long lhs, long rhs)
{
	return applyEvaluator<Op>(static_cast<long>(lhs), rhs);
}
template<Operator Op>
bool
compare(unsigned long long lhs, long long rhs)
{
	return applyEvaluator<Op>(static_cast<long>(lhs), rhs);
}
template<Operator Op>
bool
compare(unsigned long long lhs, char rhs)
{
	return applyEvaluator<Op>(static_cast<long>(lhs), rhs);
}
...
template<Operator Op, typename T>
bool
compare(long long lhs, T* rhs)
{
	return Evaluator<T*, T*, Op>::evaluate(reinterpret_cast<T*>(lhs), rhs);
}
template<Operator Op, typename T>
bool
compare(T* lhs, long long rhs)
{
	return Evaluator<T*, T*, Op>::evaluate(lhs, reinterpret_cast<T*>(rhs));
}
...
template<Operator Op, typename T>
bool
compare(std::nullptr_t, T* rhs)
{
	return Evaluator<T*, T*, Op>::evaluate(nullptr, rhs);
}
template<Operator Op, typename T>
bool
compare(T* lhs, std::nullptr_t)
{
...
std::string
toString(std::wstring const& value);
std::string
toString(const char* const value);
std::string
toString(char* const value);
std::string
toString(const wchar_t* const value);
std::string
toString(wchar_t* const value);
std::string
toString(int value);
std::string
toString(unsigned long value);
std::string
...
toString(char value);
std::string
toString(signed char value);
std::string
toString(unsigned char value);

#ifdef CATCH_CONFIG_CPP11_LONG_LONG
std::string
toString(long long value);
std::string
toString(unsigned long long value);
#endif
...
#ifdef __OBJC__
std::string
toString(NSString const* const& nsstring);
std::string
toString(NSString* CATCH_ARC_STRONG const& nsstring);
std::string
toString(NSObject* const& nsObject);
#endif
...
TrueType&
testStreamable(std::ostream&);
FalseType testStreamable(FalseType);

FalseType
operator<<(std::ostream const&, BorgType const&);
...
template<typename T, typename Allocator>
std::string
toString(std::vector<T, Allocator> const& v)
{
	return Detail::rangeToString(v.begin(), v.end());
}
...
template<typename T>
inline ExpressionLhs<T const&>
ResultBuilder::operator<=(T const& operand)
{
	return ExpressionLhs<T const&>(*this, operand);
}

inline ExpressionLhs<bool>
ResultBuilder::operator<=(bool value)
{
...
#define INTERNAL_CATCH_TEST(expr, resultDisposition, macroName)                                    \
	...
	} while (Catch::isTrue(false && (expr))) // expr here is never evaluated at runtime but it
...
#define INTERNAL_CATCH_THROWS(expr, resultDisposition, matcher, macroName)                         \
	do {                                                                                           \
		Catch::ResultBuilder __catchResult(                                                        \
		    macroName, CATCH_INTERNAL_LINEINFO, #expr, resultDisposition, #matcher);               \
...
#define INTERNAL_CHECK_THAT(arg, matcher, resultDisposition, macroName)                            \
	do {                                                                                           \
		Catch::ResultBuilder __catchResult(                                                        \
		    macroName, CATCH_INTERNAL_LINEINFO, #arg " " #matcher, resultDisposition);             \
		try {                                                                                      \
			std::string matcherAsString = (matcher).toString();                                    \
			__catchResult.setLhs(Catch::toString(arg))                                             \
			    .setRhs(                                                                           \
			        matcherAsString == Catch::Detail::unprintableString ? #matcher                 \
			                                                            : matcherAsString)         \
			    .setOp("matches")                                                                  \
...
class CompositeGenerator
{
  public:
	...
	operator T() const
	{
		...
		return T(); // Suppress spurious "not all control paths return a value" warning in Visual
		            // Studio - if you know how to fix this please do so
	}
...
template<typename T>
CompositeGenerator<T>
values(T val1, T val2, T val3, T val4)
{
	CompositeGenerator<T> generators;
	ValuesGenerator<T>* valuesGen = new ValuesGenerator<T>();
	valuesGen->add(val1);
...
template<>
inline std::string
toString<Detail::Approx>(Detail::Approx const& value)
{
...
struct Equals : StringHolder<Equals>
{
	...
	virtual std::string toString() const { return "equals string: " + Catch::toString(m_substr); }
};
...
struct Contains : StringHolder<Contains>
{
	...
	virtual std::string toString() const { return "contains string: " + Catch::toString(m_substr); }
};
...
struct StartsWith : StringHolder<StartsWith>
{
	...
	virtual std::string toString() const { return "starts with: " + Catch::toString(m_substr); }
};
struct EndsWith : StringHolder<EndsWith>
{
	...
	virtual std::string toString() const { return "ends with: " + Catch::toString(m_substr); }
};
...
#define OC_TEST_CASE(name, desc)                                                                   \
	...
	+(NSString*)INTERNAL_CATCH_UNIQUE_NAME(Catch_Description_test) { return @desc; }               \
...
class Text
{
  public:
	  ...
	  : attr(_attr)
	{
		...
		std::size_t indent =
		    _attr.initialIndent != std::string::npos ? _attr.initialIndent : _attr.indent;
...
template<typename T>
void
convertInto(std::string const& _source, T& _dest)
{
	std::stringstream ss;
	ss << _source;
	ss >> _dest;
...
inline void
convertInto(std::string const& _source, std::string& _dest)
{
	_dest = _source;
}
inline void
convertInto(std::string const& _source, bool& _dest)
{
	...
	if (sourceLC == "y" || sourceLC == "1" || sourceLC == "true" || sourceLC == "yes" ||
	    ...
	    sourceLC == "n" || sourceLC == "0" || sourceLC == "false" || sourceLC == "no" ||
	    sourceLC == "off")
		_dest = false;
	else
...
inline void
convertInto(bool _source, bool& _dest)
{
	_dest = _source;
}
template<typename T>
...
class BoundArgFunction
{
  public:
	...
	bool isSet() const { return functionObj != CATCH_NULL; }
...
struct Parser
{
	...
	void parseIntoTokens(int argc, char const* const* argv, std::vector<Parser::Token>& tokens)
	    const
	{
...
class CommandLine
{
	...
	class ArgBuilder
	{
	  public:
		...
		// Bind a free function taking a single argument - the object to operate on (no placeholder
		// string required)
		template<typename C>
		...
		// Bind a free function taking a single argument - the object to operate on (requires a
		// placeholder string)
		template<typename C, typename T>
  ...
  public:
	    ...
	    std::size_t width = Detail::consoleWidth) const
	{
		...
		for (it = itBegin; it != itEnd; ++it) {
			Detail::Text usageText(
			    it->commands(),
			    Detail::TextAttributes().setWidth(maxWidth + indent).setIndent(indent));
			Detail::Text desc(
			    it->description, Detail::TextAttributes().setWidth(width - maxWidth - 3));
	...
	std::vector<Parser::Token> populate(std::vector<Parser::Token> const& tokens, ConfigT& config)
	    const
	{
		validate();
	...
	std::vector<Parser::Token> populateOptions(
	    std::vector<Parser::Token> const& tokens,
...
inline void
abortAfterFirst(ConfigData& config)
{
	config.abortAfter = 1;
}
inline void
abortAfterX(ConfigData& config, int x)
{
	if (x < 1)
...
inline void
addTestOrTags(ConfigData& config, std::string const& _testSpec)
{
	config.testsOrTags.push_back(_testSpec);
}
inline void
addReporterName(ConfigData& config, std::string const& _reporterName)
{
	config.reporterNames.push_back(_reporterName);
}

inline void
addWarning(ConfigData& config, std::string const& _warning)
{
...
inline void
setOrder(ConfigData& config, std::string const& order)
{
...
inline void
setRngSeed(ConfigData& config, std::string const& seed)
{
	if (seed == "time") {
...
inline void
setVerbosity(ConfigData& config, int level)
{
	// !TBD: accept strings?
	config.verbosity = static_cast<Verbosity::Level>(level);
}
inline void
setShowDurations(ConfigData& config, bool _showDurations)
{
	config.showDurations = _showDurations ? ShowDurations::Always : ShowDurations::Never;
}
inline void
loadTestNamesFromFile(ConfigData& config, std::string const& _filename)
{
...
inline Clara::CommandLine<ConfigData>
...
struct IReporterRegistry
{
	...
	virtual IStreamingReporter* create(std::string const& name, Ptr<IConfig const> const& config)
	    const = 0;
...
addReporter(
    Ptr<IStreamingReporter> const& existingReporter,
...
inline std::size_t
listReporters(Config const& /*config*/)
{
...
inline Option<std::size_t>
list(Config const& config)
{
...
class TrackerBase : public ITracker
{
  ...
  public:
	...
	virtual bool hasChildren() const CATCH_OVERRIDE { return !m_children.empty(); }
	...
	virtual ITracker* findChild(std::string const& name) CATCH_OVERRIDE
	{
		Children::const_iterator it =
		    std::find_if(m_children.begin(), m_children.end(), TrackerHasName(name));
...
inline void
fatal(std::string const& message, int exitCode)
{
  ...
  , public IRunner
{
  ...
  private: // IResultCapture
	...
	virtual void pushScopedMessage(MessageInfo const& message) { m_messages.push_back(message); }
  ...
  private:
	void runCurrentTest(std::string& redirectedCout, std::string& redirectedCerr)
	{
		...
		try {
			m_lastAssertionInfo =
			    AssertionInfo("TEST_CASE", testCaseInfo.lineInfo, "", ResultDisposition::Normal);
...
Ptr<IStreamingReporter>
createReporter(std::string const& reporterName, Ptr<Config> const& config)
{
...
Ptr<IStreamingReporter>
makeReporter(Ptr<Config> const& config)
{
...
Ptr<IStreamingReporter>
addListeners(Ptr<IConfig const> const& config, Ptr<IStreamingReporter> reporters)
{
...
Totals
runTests(Ptr<Config> const& config)
{
...
void
applyFilenamesAsTags(IConfig const& config)
{
...
enforceNoDuplicateTestCases(std::vector<TestCase> const& functions)
{
	...
	for (std::vector<TestCase>::const_iterator it = functions.begin(), itEnd = functions.end();
		...
		if (!prev.second) {
			Catch::cerr() << Colour(Colour::Red) << "error: TEST_CASE( \"" << it->name
			              << "\" ) already defined.\n"
...
class ReporterRegistry : public IReporterRegistry
{
  ...
  public:
	...
	virtual FactoryMap const& getFactories() const CATCH_OVERRIDE { return m_factories; }
	virtual Listeners const& getListeners() const CATCH_OVERRIDE { return m_listeners; }
  ...
  , public IMutableRegistryHub
{
  ...
  public: // IMutableRegistryHub
	virtual void registerReporter(std::string const& name, Ptr<IReporterFactory> const& factory)
	    CATCH_OVERRIDE
	{
...
const char*
NotImplementedException::what() const CATCH_NOEXCEPT
{
	return m_what.c_str();
}
...
platformColourInstance()
{
	...
	return (config && config->forceColour()) || isatty(STDOUT_FILENO) ? PosixColourImpl::instance()
...
void
setTags(TestCaseInfo& testCaseInfo, std::set<std::string> const& tags)
{
	testCaseInfo.tags = tags;
	testCaseInfo.lcaseTags.clear();

	std::ostringstream oss;
	for (std::set<std::string>::const_iterator it = tags.begin(), itEnd = tags.end(); it != itEnd;
	     ++it) {
		oss << "[" << *it << "]";
...
ReporterPreferences
LegacyReporterAdapter::getPreferences() const
{
...
void
LegacyReporterAdapter::noMatchingTestCases(std::string const&)
{}
void
LegacyReporterAdapter::testRunStarting(TestRunInfo const&)
{
	m_legacyReporter->StartTesting();
}
void
LegacyReporterAdapter::testGroupStarting(GroupInfo const& groupInfo)
{
	m_legacyReporter->StartGroup(groupInfo.name);
}
void
LegacyReporterAdapter::testCaseStarting(TestCaseInfo const& testInfo)
{
	m_legacyReporter->StartTestCase(testInfo);
}
void
LegacyReporterAdapter::sectionStarting(SectionInfo const& sectionInfo)
{
	m_legacyReporter->StartSection(sectionInfo.name, sectionInfo.description);
}
void
LegacyReporterAdapter::assertionStarting(AssertionInfo const&)
{
...
void
LegacyReporterAdapter::sectionEnded(SectionStats const& sectionStats)
{
...
LegacyReporterAdapter::testCaseEnded(TestCaseStats const& testCaseStats)
{
	m_legacyReporter->EndTestCase(
	    testCaseStats.testInfo, testCaseStats.totals, testCaseStats.stdOut, testCaseStats.stdErr);
}
void
...
void
LegacyReporterAdapter::testRunEnded(TestRunStats const& testRunStats)
{
	m_legacyReporter->EndTesting(testRunStats.totals);
}
void
LegacyReporterAdapter::skipTest(TestCaseInfo const&)
{}
}
...
unsigned int
Timer::getElapsedMicroseconds() const
{
	return static_cast<unsigned int>(getCurrentTicks() - m_ticks);
}
unsigned int
Timer::getElapsedMilliseconds() const
{
...
{}
bool
SourceLineInfo::empty() const
{
	return file.empty();
}
bool
SourceLineInfo::operator==(SourceLineInfo const& other) const
{
...
toString(char value)
{
	return value < ' ' ? toString(static_cast<unsigned int>(value)) : Detail::makeString(value);
}
...
capturedExpressionWithSecondArgument(
    std::string const& capturedExpression,
    std::string const& secondArg)
{
	return secondArg.empty() || secondArg == "\"\"" ? capturedExpression
...
ResultBuilder::ResultBuilder(
  ...
  : m_assertionInfo(
        macroName,
        lineInfo,
        capturedExpressionWithSecondArgument(capturedExpression, secondArg),
        resultDisposition)
...
void
ResultBuilder::useActiveException(ResultDisposition::Flags resultDisposition)
{
...
void
ResultBuilder::captureResult(ResultWas::OfType resultType)
{
...
void
ResultBuilder::captureExpectedException(Matchers::Impl::Matcher<std::string> const& matcher)
{
...
void
ResultBuilder::handleResult(AssertionResult const& result)
{
...
bool
ResultBuilder::shouldDebugBreak() const
{
	return m_shouldDebugBreak;
}
bool
ResultBuilder::allowThrows() const
{
	return getCurrentContext().getConfig()->allowThrows();
}

AssertionResult
ResultBuilder::build() const
{
...
std::string
ResultBuilder::reconstructExpression() const
{
	if (m_exprComponents.op == "")
...
void
TagAliasRegistry::add(char const* alias, char const* tag, SourceLineInfo const& lineInfo)
{
...
struct StreamingReporterBase : SharedImpl<IStreamingReporter>
{
	...
	virtual ReporterPreferences getPreferences() const CATCH_OVERRIDE { return m_reporterPrefs; }
...
struct TestEventListenerBase : StreamingReporterBase
{
	...
	virtual void assertionStarting(AssertionInfo const&) CATCH_OVERRIDE {}
	virtual bool assertionEnded(AssertionStats const&) CATCH_OVERRIDE { return false; }
};
...
class JunitReporter : public CumulativeReporterBase
{
  public:
	...
	void writeGroup(TestGroupNode const& groupNode, double suiteTime)
	{
		...
		// Write test cases
		for (TestGroupNode::ChildNodes::const_iterator it = groupNode.children.begin(),
  ...
  private:
	...
	void printTestCaseAndSectionHeader()
	{
		...
		if (m_sectionStack.size() > 1) {
			...
			std::vector<SectionInfo>::const_iterator it = m_sectionStack.begin() +
...
#define CATCH_REQUIRE_THROWS(expr)                                                                 \
	INTERNAL_CATCH_THROWS(expr, Catch::ResultDisposition::Normal, "", "CATCH_REQUIRE_THROWS")
#define CATCH_REQUIRE_THROWS_AS(expr, exceptionType)                                               \
	INTERNAL_CATCH_THROWS_AS(                                                                      \
	    expr, exceptionType, Catch::ResultDisposition::Normal, "CATCH_REQUIRE_THROWS_AS")
#define CATCH_REQUIRE_THROWS_WITH(expr, matcher)                                                   \
	INTERNAL_CATCH_THROWS(                                                                         \
	    expr, Catch::ResultDisposition::Normal, matcher, "CATCH_REQUIRE_THROWS_WITH")
#define CATCH_REQUIRE_NOTHROW(expr)                                                                \
	INTERNAL_CATCH_NO_THROW(expr, Catch::ResultDisposition::Normal, "CATCH_REQUIRE_NOTHROW")

#define CATCH_CHECK(expr)                                                                          \
	INTERNAL_CATCH_TEST(expr, Catch::ResultDisposition::ContinueOnFailure, "CATCH_CHECK")
...
#define CATCH_CHECKED_IF(expr)                                                                     \
	INTERNAL_CATCH_IF(expr, Catch::ResultDisposition::ContinueOnFailure, "CATCH_CHECKED_IF")
#define CATCH_CHECKED_ELSE(expr)                                                                   \
	INTERNAL_CATCH_ELSE(expr, Catch::ResultDisposition::ContinueOnFailure, "CATCH_CHECKED_ELSE")
...
#define CATCH_CHECK_THROWS(expr)                                                                   \
	INTERNAL_CATCH_THROWS(expr, Catch::ResultDisposition::ContinueOnFailure, "CATCH_CHECK_THROWS")
#define CATCH_CHECK_THROWS_AS(expr, exceptionType)                                                 \
	INTERNAL_CATCH_THROWS_AS(                                                                      \
	    expr, exceptionType, Catch::ResultDisposition::ContinueOnFailure, "CATCH_CHECK_THROWS_AS")
#define CATCH_CHECK_THROWS_WITH(expr, matcher)                                                     \
	INTERNAL_CATCH_THROWS(                                                                         \
	    expr, Catch::ResultDisposition::ContinueOnFailure, matcher, "CATCH_CHECK_THROWS_WITH")
...
#define CHECK_THAT(arg, matcher)                                                                   \
	INTERNAL_CHECK_THAT(                                                                           \
	    arg, matcher, Catch::ResultDisposition::ContinueOnFailure, "CATCH_CHECK_THAT")
#define CATCH_REQUIRE_THAT(arg, matcher)                                                           \
	INTERNAL_CHECK_THAT(arg, matcher, Catch::ResultDisposition::Normal, "CATCH_REQUIRE_THAT")

#define CATCH_INFO(msg) INTERNAL_CATCH_INFO(msg, "CATCH_INFO")
#define CATCH_WARN(msg)                                                                            \
	INTERNAL_CATCH_MSG(                                                                            \
	    Catch::ResultWas::Warning, Catch::ResultDisposition::ContinueOnFailure, "CATCH_WARN", msg)
...
#define CATCH_FAIL(msg)                                                                            \
	INTERNAL_CATCH_MSG(                                                                            \
	    Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal, "CATCH_FAIL", msg)
#define CATCH_SUCCEED(msg)                                                                         \
	INTERNAL_CATCH_MSG(                                                                            \
	    Catch::ResultWas::Ok, Catch::ResultDisposition::ContinueOnFailure, "CATCH_SUCCEED", msg)
#endif
...
#define REQUIRE_THROWS(expr)                                                                       \
	INTERNAL_CATCH_THROWS(expr, Catch::ResultDisposition::Normal, "", "REQUIRE_THROWS")
#define REQUIRE_THROWS_AS(expr, exceptionType)                                                     \
	INTERNAL_CATCH_THROWS_AS(                                                                      \
	    expr, exceptionType, Catch::ResultDisposition::Normal, "REQUIRE_THROWS_AS")
...
#define REQUIRE_NOTHROW(expr)                                                                      \
	INTERNAL_CATCH_NO_THROW(expr, Catch::ResultDisposition::Normal, "REQUIRE_NOTHROW")
...
#define CHECKED_IF(expr)                                                                           \
	INTERNAL_CATCH_IF(expr, Catch::ResultDisposition::ContinueOnFailure, "CHECKED_IF")
#define CHECKED_ELSE(expr)                                                                         \
	INTERNAL_CATCH_ELSE(expr, Catch::ResultDisposition::ContinueOnFailure, "CHECKED_ELSE")
...
#define CHECK_THROWS(expr)                                                                         \
	INTERNAL_CATCH_THROWS(expr, Catch::ResultDisposition::ContinueOnFailure, "", "CHECK_THROWS")
#define CHECK_THROWS_AS(expr, exceptionType)                                                       \
	INTERNAL_CATCH_THROWS_AS(                                                                      \
	    expr, exceptionType, Catch::ResultDisposition::ContinueOnFailure, "CHECK_THROWS_AS")
#define CHECK_THROWS_WITH(expr, matcher)                                                           \
	INTERNAL_CATCH_THROWS(                                                                         \
	    expr, Catch::ResultDisposition::ContinueOnFailure, matcher, "CHECK_THROWS_WITH")
#define CHECK_NOTHROW(expr)                                                                        \
	INTERNAL_CATCH_NO_THROW(expr, Catch::ResultDisposition::ContinueOnFailure, "CHECK_NOTHROW")
...
#define WARN(msg)                                                                                  \
	INTERNAL_CATCH_MSG(                                                                            \
	    Catch::ResultWas::Warning, Catch::ResultDisposition::ContinueOnFailure, "WARN", msg)
...
#define FAIL(...)                                                                                  \
	INTERNAL_CATCH_MSG(                                                                            \
	    Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal, "FAIL", __VA_ARGS__)
#define SUCCEED(...)                                                                               \
	INTERNAL_CATCH_MSG(                                                                            \
	    Catch::ResultWas::Ok, Catch::ResultDisposition::ContinueOnFailure, "SUCCEED", __VA_ARGS__)
#else
...
#define FAIL(msg)                                                                                  \
	INTERNAL_CATCH_MSG(                                                                            \
	    Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal, "FAIL", msg)
#define SUCCEED(msg)                                                                               \
	INTERNAL_CATCH_MSG(                                                                            \
	    Catch::ResultWas::Ok, Catch::ResultDisposition::ContinueOnFailure, "SUCCEED", msg)
#endif
