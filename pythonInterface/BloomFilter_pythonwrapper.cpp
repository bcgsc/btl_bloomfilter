...
//private:
    ...
    unsigned m_kmerSize;
      ...
      //  Introducing member function pointer variables for multiHash:  
       ...
       vector<size_t> (BloomFilter::*fx2)(const char*, uint64_t&, uint64_t&) const = &BloomFilter::multiHash;
       vector<size_t> (BloomFilter::*fx3)(uint64_t&, uint64_t&, const char, const char) const= &BloomFilter::multiHash;
